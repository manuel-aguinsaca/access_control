...
<head>
    ...
    <script src="<?=base_url()?>recursos/js/notificaciones.js"></script>
    ...
    <div class="main-content">
                <div class="main-content-inner">   
                    ...
                    <div class="page-content">  
                        <button type="button" onclick="notificaciones('titulo', 'Mensaje', 'http://localhost/access_control/index.php/controlador/');">Notificar</button>
